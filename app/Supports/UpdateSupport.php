...
//        }
        ...
        try {
            ...
            if(!Schema::hasColumn('swot_analyses','product_id'))
            {
                Schema::table('swot_analyses', function (Blueprint $table) {
                    $table->unsignedInteger('product_id')->default(0);
                });
            }
            if(!Schema::hasColumn('subscription_plans','paypal_yearly_plan_id'))
            {
                Schema::table('subscription_plans', function (Blueprint $table) {
            ...
            {
                Schema::table('users', function (Blueprint $table) {
                    $table->boolean('is_email_verified')->default(true)->after('email');
                    $table->string('email_verification_token')->nullable()->after('is_email_verified');
                });
            }
            ...
            if(!Schema::hasTable('smart_goals'))
            {
