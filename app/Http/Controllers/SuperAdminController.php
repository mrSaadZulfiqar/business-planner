...
class SuperAdminController extends SuperAdminBaseController
{
    ...
    public function subscriptionPlanPost(Request $request)
    {
        ...
        $plan->paypal_yearly_plan_id = $request->paypal_yearly_plan_id;
    ...
    public function pricingPage()
    {
        ...
        return \view('super-admin.pricing-page-editor',[
            'selected_navigation' => 'pricing-page',
    ...
    public function testEmail(Request $request)
    {
        ...
        {
            return redirect("/email-setting")->withErrors([
                'error' => $e->getMessage()
            ]);
        }

        return redirect("/email-setting")->with([
