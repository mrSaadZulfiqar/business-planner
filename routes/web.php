...
use App\Http\Controllers\SwotAiController;
use App\Http\Controllers\SwotController;
use App\Http\Controllers\TaskController;
use Illuminate\Support\Facades\Artisan;
use Illuminate\Support\Facades\Route;
use App\Http\Controllers\PestAiController;
use App\Http\Controllers\PlansAiController;
use App\Http\Controllers\PestelAiController;
use App\Http\Controllers\PorterAiController;
use App\Http\Controllers\MckinseyAiController;
use App\Http\Controllers\MarketingAiController;
use App\Http\Controllers\SalesRepositoryController;
use App\Http\Controllers\StartupCanvasAiController;
...
// In Laravel, add the following to routes/web.php

Route::view('/trial-expired','trial_expired_modal')->name('show.expired.modal');
...
Route::middleware('trial.check')->group(function () {
	...
	Route::get("/sales-repository", [SalesRepositoryController::class, "index"]);
...
Route::post("/test-email", [SuperAdminController::class, "testEmail"]);
...
Route::get("/resend", [AuthController::class, "sendOtp"])->name('resend.phonecode');
...
Route::post("/swot-ai", [SwotAiController::class, "ai"]);
Route::post("/pest-ai", [PestAiController::class, "ai"]);
Route::post("/pestel-ai", [PestelAiController::class, "ai"]);
Route::post("/plans-ai", [PlansAiController::class, "ai"]);
Route::post("/marketing-ai", [MarketingAiController::class, "ai"]);
Route::post("/startup-canvas-ai", [StartupCanvasAiController::class, "ai"]);
Route::post("/mckinsey-ai", [MckinseyAiController::class, "ai"]);
Route::post("/porter-ai", [PorterAiController::class, "ai"]);
