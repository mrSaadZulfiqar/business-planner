...
@section('content')
    ...
    <div class=" row">
        ...
        <div class="col text-end">
            <a href="/write-pest" type="button" class="btn btn-info " data-bs-toggle="modal" data-bs-target="#exampleModal">  {{__('New PEST Analysis')}}</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">{{__('PEST Analysis')}}</h1>
