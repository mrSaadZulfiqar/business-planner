...
@section('content')
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-10">
            <div class="card-group" id="pestPDF">
...
<script>
    function generatePDF() {
        ...
        const element = document.getElementById('pestPDF'); // Replace 'content' with the ID of your HTML element
      
        // Convert HTML to PDF using html2pdf
        html2pdf(element, {
            margin: 10,
            filename: 'PEST Analysis of {{$model->company_name}}.pdf',
