...
@section('content')
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-11">
            <div class="card-group" id="pestlePDF">
...
<script>
    function generatePDF() {
        ...
        const element = document.getElementById('pestlePDF'); // Replace 'content' with the ID of your HTML element
      
        // Convert HTML to PDF using html2pdf
        html2pdf(element, {
            margin: 10,
            filename: 'PESTLE Analysis of {{$model->company_name}}.pdf',
