...
@section('content')
    ...
    <div class=" row">
        ...
        <div class="col text-end">
            <a href="/new-porter" type="button" class="btn btn-info " data-bs-toggle="modal" data-bs-target="#exampleModal">  {{__('New Porter\'s Five Forces Model')}}</a>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">{{__('New Porter\'s Five Forces Model')}}</h1>
