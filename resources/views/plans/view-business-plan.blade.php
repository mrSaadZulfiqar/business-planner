...
<script>
    function generatePDF() {
        ...
        const element = document.getElementById('planPDF'); // Replace 'content' with the ID of your HTML element
      
        // Convert HTML to PDF using html2pdf
        html2pdf(element, {
            margin: 10,
            filename: 'Business Plan of {{$plan->company_name}}.pdf',
