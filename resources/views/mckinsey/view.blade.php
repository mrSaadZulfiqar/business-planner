...
<script>
    function generatePDF() {
        ...
        const element = document.getElementById('mckinseyPDF'); // Replace 'content' with the ID of your HTML element
      
        // Convert HTML to PDF using html2pdf
        html2pdf(element, {
            margin: 10,
            filename: 'McKinsey 7-S Model of {{$model->company_name}}.pdf',
