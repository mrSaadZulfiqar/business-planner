...
<script>
    function generatePDF() {
        ...
        const element = document.getElementById('canvasPDF'); // Replace 'content' with the ID of your HTML element
      
        // Convert HTML to PDF using html2pdf
        html2pdf(element, {
            margin: 10,
            filename: 'Startup Canvas of {{$model->company_name}}.pdf',
