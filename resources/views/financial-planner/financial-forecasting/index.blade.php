...
@section('content')
    <div class="card bg-purple-light mb-3 mt-4">
        <div class="card-header bg-purple-light pb-0 p-3">
            <div class="row">
                <div class="col-md-8 ">
                    <h6 >{{__('Financial Forecast Reports')}} </h6>

                </div>
                <div class="col-md-4 text-right">

                    <a class="btn bg-gradient-dark" href="/add-financial-forecast"><i class="fas fa-plus"></i>&nbsp;&nbsp;
                        {{__(' Add New Forecast ')}}
                    </a>
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0" id="cloudonex_table">
                            ...
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ps-2">{{__('Creation Date')}}</th>
                                <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-7">{{__('Format')}}</th>
